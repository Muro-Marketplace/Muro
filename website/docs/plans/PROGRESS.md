...
Commit `<pending>`. `components/BlogEditor.tsx` + new test. (This is ONLY the authFetch→mutate half of bug-12; the blog feature-flag gate + `notFound()` is a SEPARATE later iteration.)
