  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-3 left-3 z-40 inline-flex items-center gap-1.5 px-3 py-2 min-h-11 rounded-full bg-accent-text text-white text-xs font-medium shadow-md hover:bg-accent-text-hover transition-colors"
      >
      ...
      {open && (
        <div
          role="dialog"
          aria-label="Feedback"
          className="fixed bottom-16 left-3 z-40 w-[360px] max-w-[calc(100vw-1.5rem)] bg-surface border border-border rounded-sm shadow-lg overflow-hidden"
        >
