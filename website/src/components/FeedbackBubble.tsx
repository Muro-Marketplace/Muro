  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-3 left-3 z-40 inline-flex items-center gap-1.5 px-3 py-2 rounded-full bg-accent text-white text-xs font-medium shadow-md hover:bg-accent-hover transition-colors"
      >
