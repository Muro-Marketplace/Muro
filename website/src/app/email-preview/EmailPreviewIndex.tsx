// Email template browser. Lists every template in the registry with stream /
// persona / category filters and a search box. Click a template to preview the
// rendered HTML in a new tab.
//
// The environment gate lives in page.tsx, which is a server component and can
// therefore read the environment before this renders at all (B4). This file is the
// client UI only.
