...
export default function ArtistShowroomEditorPage() {
  // Read the dynamic segment through the hook: a client page needs no
  // params promise, and the editor renders without a Suspense round trip.
  const routeParams = useParams<{ id: string }>();
  const wallId = typeof routeParams?.id === "string" ? routeParams.id : "";
