...
export const metadata: Metadata = {
  title: "Artist Agreement – Wallspace",
  description: "The agreement between Wallspace and artists accepted onto the platform.",
};
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  <p>This agreement takes effect upon your acceptance onto the Wallspace platform. You must be at least 18 years old. Acceptance is at Wallspace&rsquo;s sole discretion, based on the quality, originality, consistency, and commercial suitability of your work.</p>
                  <p>Wallspace reserves the right to decline or revoke acceptance at any time.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  ...
                  <p>Membership is billed monthly via Stripe. Upgrades are prorated. Downgrades take effect at the next billing period. Wallspace may change pricing with 30 days&rsquo; notice. Existing subscriptions are honoured until the next renewal after the notice period.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  ...
                  <p>You must keep your portfolio current. Update or remove listings for sold, damaged, or unavailable work promptly. Wallspace may remove non-compliant listings without notice.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  ...
                  <p>You agree to indemnify Wallspace against any claims arising from a breach of these warranties.</p>
                </div>
              </div>

              <div>
                <h2 className="text-2xl mb-4">6. Licence Grant to Wallspace</h2>
                <div className="space-y-3 text-muted leading-relaxed">
                  <p>You grant Wallspace a non-exclusive, worldwide, royalty-free licence to use, display, reproduce, and distribute images of your artwork for:</p>
                  <ul className="list-disc pl-6 space-y-1">
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  <p>You may lend artwork to a venue at no cost (a &ldquo;Free Loan&rdquo;). The specific terms of each Free Loan are agreed directly between you and the venue, facilitated by Wallspace.</p>
                  <p>Artwork remains your property throughout the loan period. The venue is expected to exercise reasonable care. You are responsible for insuring your artwork during the loan period. Wallspace is not liable for damage, loss, or theft during a Free Loan.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  <p>You are responsible for insuring your own artwork, both in transit and while on display in venues. Wallspace does not provide artwork insurance.</p>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  ...
                  <p>Wallspace may request proof of originality at any time. Mass-produced, drop-shipped, or misattributed work is prohibited.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  <p>Wallspace may remove listings or suspend your account for breach of this agreement, quality failures, credible intellectual property complaints, fulfilment failures, or conduct that brings the Platform into disrepute.</p>
                  <p>Where possible, Wallspace will provide notice and an opportunity to remedy the issue before taking action. Immediate suspension may occur for serious breaches.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  <p>You may cancel your membership at any time with 30 days&rsquo; written notice (email to <a href="mailto:hello@wallspace.co" className="text-accent hover:underline">hello@wallspace.co</a> or via your account settings).</p>
                  ...
                  <p>You must collect all artwork from venues within 30 days of your cancellation date. If artwork remains uncollected after 60 days, Wallspace may arrange return at your cost or store the artwork at your risk and cost.</p>
