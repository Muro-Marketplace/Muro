...
export const metadata: Metadata = {
  title: "Venue Partnership Agreement",
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  ...
                  <p>Venues never pay a platform fee. Wallplace&rsquo;s revenue comes from artist memberships, a platform fee on sales, and optional services venues can choose, such as Wallplace Programmes and Wallplace Curated.</p>
                  ...
                  <p>Optional paid services, such as Wallplace Programmes and Wallplace Curated, are priced exclusive of VAT. If Wallplace becomes VAT registered, VAT will be added at the prevailing rate.</p>
                </div>
              </div>
